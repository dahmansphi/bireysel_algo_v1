...
## bireysel_algo package __version__1.0
...
of the Bireysel Algorithm, official released name **bireysel_algo**. This package will serve as a **testing** tool 
...
# Installation 
> [!TIP]
> The first edition bireysel_algo is tested on several **problematic** datasets. What I mean by problematic is 
